...
<body>
    ...
    <div class="container-fluid col-xl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button data-id="<?= $trottinette['trottinette_id'] ?>"
                                class="btnList btn btn-outline-warning">
                                <?= $trottinette['trottinette_valid'] ? "Retirer de la liste" : "Afficher sur la liste" ?>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center">
            <a href="list.php" class="btn btn-success btn-lg my-4">Voir la liste</a>
        </div>
    </div>
